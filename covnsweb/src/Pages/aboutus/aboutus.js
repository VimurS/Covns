                ...
                <div>
                    <div className='abtSec'>
                        ...
                        <p className='overviewP'>
                            Covn's is a pioneering startup based in Coimbatore, founded by two enthusiastic and forward-thinking youngsters. Their vision is to provide the local community with access to high-quality organic milk.
                        ...
                        <h3 className='overview'>Get To Know Our Founders</h3>
                        ...
                        <div id='vim'>
                            ...
                            <p><span className='founderTag'>Vimur, Co Founder - <span className='coSpan3'>Co</span><span className='Vspan3'>v</span><span className='coSpan3'>n</span><span className='apoSpan3'>'</span><span className='coSpan3'>s</span></span><br></br>This initiative stems from their deep-rooted belief in the importance of consuming organic products and creating a healthier society, especially in today's modernized world where processed and unhealthy foods have become prevalent.
                                organic milk offers numerous advantages over conventional milk.
                            </p>
                            {/* <p className='founderTag'>Vimur, Co Founder - Covns</p> */}
                        </div>
                        <div id='vick'>
                            <p><span className='founderTag' >Vignesh, Co Founder - <span className='coSpan3'>Co</span><span className='Vspan3'>v</span><span className='coSpan3'>n</span><span className='apoSpan3'>'</span><span className='coSpan3'>s</span></span><br></br>By providing the local community with access to organic milk, Covn's aims to create a positive impact on people's health and lifestyle choices. They recognize the importance of consuming nutritious and wholesome products that contribute to overall well-being.</p>
